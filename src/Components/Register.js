...
render(){ 
  ...
  return (
    <div className="SignIn" method='post' style={{display: 'flex', /*justifyContent: 'flex-end',*/ width: '100%', height: 'auto', margin: '0px 0px 0px 0px'}}>
			  ...
			  <form className="measure center">
			    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
			     ...
			     <div className="lh-copy mt3">
			      <p onClick={this.onButtonRegister} className="f6 link dim black db pointer">Sign Up</p>
