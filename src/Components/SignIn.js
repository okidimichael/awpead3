...
render(){
	  return(
    <div className= "SignIn" method='post' style={{display: 'flex', zIndex: 400, justifyContent: 'flex-end', width: '100%', height: 'auto', margin: '0px 0px 0px 0px'}}>
  <article className="br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l shadow-5  mw5 center">
			  ...
			  <div className="measure">
			    ...
			    <div className="lh-copy mt3">
			      ...
			      <a onClick={() => {this.props.onRouteChange('UpdateUser')}}href="#0" className="f6 link dim black db">Forgot your password?</a>
			    </div>
			  </div>
			</main>
 </article>
